...
const _dialog = [
  {
    dialog: () => (
      <SpeakerLeft pathToAvatar="./assets/punk_anon.png">
        ...
        <a href="https://chainlist.org/?search=mantle&testnets=true" target="_blank">
  ...
  },
  {
    dialog: () => (
      <SpeakerLeft pathToAvatar="./assets/punk_anon.png">
        Here is a contract just for Mantle:
      </SpeakerLeft>
    ),
  ...
  },
  {
    dialog: () => (
      <SpeakerLeft pathToAvatar="./assets/punk_anon.png">
        You can check if your contract was deployed to Mantle Blockchain.
        <input
